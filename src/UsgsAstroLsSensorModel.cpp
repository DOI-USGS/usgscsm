   ...
   const csm::EcefCoord& ground_pt) const
{
   ...
   std::cerr << "  Base image point: " << ipB.line << ", " << ipB.samp << std::endl;
   std::cerr << "  X Shift image point: " << ipX.line << ", " << ipX.samp << std::endl;
   std::cerr << "  Y Shift image point: " << ipY.line << ", " << ipY.samp << std::endl;
   std::cerr << "  Z Shift image point: " << ipZ.line << ", " << ipZ.samp << std::endl;
