...
void UsgsAstroLsSensorModel::replaceModelState(const std::string &stateString )
{
   ...
   MESSAGE_LOG(m_logger, "m_startingEphemerisTime: {} "
                               ...
                               "m_startingSample: {} "
                               "m_ikCode: {} ",
                               j["m_startingEphemerisTime"],
                               j["m_centerEphemerisTime"],
                               j["m_detectorSampleSumming"],
                               j["m_startingSample"], j["m_ikCode"])
   ...
   MESSAGE_LOG(m_logger, "m_detectorSampleOrigin: {} "
                               ...
                               "m_majorAxis: {} "
                               "m_minorAxis: {} ",
                               j["m_detectorSampleOrigin"],
                               j["m_detectorLineOrigin"],
                               j["m_majorAxis"], j["m_minorAxis"])
   ...
   MESSAGE_LOG(m_logger, "m_platformIdentifier: {} "
                               "m_sensorIdentifier: {} ",
                               j["m_platformIdentifier"], j["m_sensorIdentifier"])
   ...
   MESSAGE_LOG(m_logger, "m_dtEphem: {} "
                               ...
                               "m_dtQuat: {} "
                               "m_t0Quat: {} ",
                               j["m_dtEphem"], j["m_t0Ephem"],
                               j["m_dtQuat"], j["m_t0Quat"])
   ...
   MESSAGE_LOG(m_logger, "m_numQuaternions: {} "
                               ...
                               "m_referencePointY: {} "
                               "m_referencePointZ: {} ",
                               j["m_numQuaternions"], j["m_referencePointXyz"][0],
                               j["m_referencePointXyz"][1],
                               j["m_referencePointXyz"][2])
   ...
   MESSAGE_LOG(m_logger, "m_gsd: {} "
                               ...
                               "m_halfSwath: {} "
                               "m_halfTime: {} ",
                               j["m_gsd"], j["m_flyingHeight"],
                               j["m_halfSwath"], j["m_halfTime"])
...
std::string UsgsAstroLsSensorModel::constructStateFromIsd(const std::string imageSupportData, csm::WarningList *warnings) const
{
  ...
  MESSAGE_LOG(m_logger, "m_focalLength: {} ", state["m_focalLength"])
  ...
  MESSAGE_LOG(m_logger, "m_referencePointXyz: {} ", state["m_referencePointXyz"])
  ...
  try {
    ...
    MESSAGE_LOG(m_logger, "m_dtEphem: {} ", state["m_dtEphem"])
  }
  catch(...) {
  ...
  try {
    ...
    MESSAGE_LOG(m_logger, "t0_ephemeris: {}", state["m_t0Ephem"])
  }
  catch(...) {
    parsingWarnings->push_back(
      csm::Warning(
  ...
  try{
    ...
    MESSAGE_LOG(m_logger, "dt_quaternion: {}", state["m_dtQuat"])
  }
  catch(...) {
    parsingWarnings->push_back(
      csm::Warning(
  ...
  try{
    ...
    MESSAGE_LOG(m_logger, "m_t0Quat: {}", state["m_t0Quat"])
  }
  catch(...) {
    parsingWarnings->push_back(
      csm::Warning(
  ...
  MESSAGE_LOG(m_logger, "m_covariance: {} (should be identity)",
                              state["m_covariance"])
