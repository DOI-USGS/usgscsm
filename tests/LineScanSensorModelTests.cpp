...
TEST_F(ConstVelLineScanSensorModel, Center) {
...
TEST_F(ConstVelLineScanSensorModel, SlightlyOffCenter) {
...
TEST_F(ConstVelLineScanSensorModel, OffBody1) {
...
TEST_F(ConstVelLineScanSensorModel, OffBody2) {
...
TEST_F(ConstVelLineScanSensorModel, OffBody3) {
...
TEST_F(ConstVelLineScanSensorModel, OffBody4) {
